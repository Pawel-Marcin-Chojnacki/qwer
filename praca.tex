...
\begin{figure}[ht]
	\centering
			\includegraphics[resolution=100, scale=0.6]{leNetTraining.png}
...
\begin{figure}[ht]
	\centering
			\includegraphics[resolution=100, scale=0.6]{VGGarchitecture.png}
...
\begin{figure}[h]
	\centering
			\includegraphics[resolution=100, scale=0.6]{inceptionv3architecture.png}
		\caption{Architektura sieci Inception v3}
\end{figure}

\begin{figure}[ht]
	\centering
			\includegraphics[resolution=100]{inceptionModule.png}
