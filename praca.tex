...
% Matematyczny model perceptronu, opis jak to działa, dlaczego to działa i jakie są ograniczenia takiego modelu.
...
% Pierwsza sieć neuronowa, to będzie połączenie wielu warstw neuronów w jedną całość. Opis losowania wag, przekazanie wyjścia z jednej warstwy na drugą.
...
% Procesy nauczania -- nie wiem dokładnie co mogę tutaj opisać.
