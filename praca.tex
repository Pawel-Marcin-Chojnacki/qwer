...
\begin{figure}[h]
	\centering
			\includegraphics[resolution=120]{DeeplearningJS.png}
		\caption{Logo biblioteki deeplearning.js}
\end{figure}

\subsection{Paddle}
\begin{figure}[h]
	\centering
			\includegraphics[resolution=120]{Paddle.png}
...
% ################################
%        PORÓWNANIE WYDAJNOŚĆI ARCHITEKTUR
% ################################
