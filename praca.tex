...
%\item Błąd zestawu treningowego: 7,17\%
%\item Błąd zestawu walidacyjnego: 24,08\%
%\item Rozmiar sygnału wejściowego: 300 pikseli
%\end{itemize}
%
%Wartości po nauczaniu sieci ze strojeniem:
%\begin{itemize}
%\item Dokładność sieci: 100\%
%\item Błąd zestawu treningowego: 5,45\%
%\item Błąd zestawu walidacyjnego: 3,22\%
%\item Rozmiar sygnału wejściowego: 300 pikseli
%\end{itemize}
...
\subsection{Inception} % rozmiar 200 pikseli
%\begin{itemize}
%\item Dokładność sieci: 93,75\%
...
%Trening podstawowy. Bez dostrajania parametrów sieci:
%CPU:  Epoki: 6, training_loss: 0.085107 validation_loss: 0.101677, accuracy: 1.0
%real	0m10.201s
%user	2m8.983s
%sys	0m5.774s
%
%GPU: Epoch: 6, training_loss: 0.080002 validation_loss: 0.10515, accuracy: 0.9375
%real	0m12.383s
%user	0m12.263s
%sys	0m8.115s
%
%Cały trening:
%CPU: Epoch: 6, training_loss: 0.075047 validation_loss: 0.037492 accuracy: 1.0
%real	43m32.039s
%user	496m49.894s
%sys	916m41.221s
