...
- normal
- pneumonia
Podział danych na zestawy treningowe, uczące i walidacyjny zwyczajowo jest w w proporcjach 70%/25%/5%. Tutaj jest podobnie.
...
## Analiza wyników
### AlexNet
Nie ma co się spodziewać wielkich wyników po debiutancie z 2012 roku. Szczególnie dlatego będzie to świetny odnośnik do pozostałych architektur, by porównać jak wiele się zmieniło przez zaledwie kilka lat.
### VGG,
###Densenet,
###Inception,
###Resnet34,
...
## Porównanie czasu uczenia (CPU i GPU)
